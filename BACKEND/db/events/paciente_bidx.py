...
def register_paciente_events():
    """Register SQLAlchemy event listeners for Paciente blind indexes.

    Called after models are fully loaded to avoid circular imports.
    """
