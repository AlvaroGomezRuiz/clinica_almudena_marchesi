        ...
        <section className="space-y-10 text-ink-soft leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <strong className="text-ink">Titular:</strong> Almudena Marchesi
                Fernández
              </li>
              <li>
                <strong className="text-ink">Colegiación:</strong> Colegio
                Oficial de Psicólogos de Madrid, Col. M-40804
              </li>
              <li>
                <strong className="text-ink">Domicilio profesional:</strong>{' '}
                Calle de Meléndez Valdés 22, 1D, 28015 Madrid, España
              </li>
              <li>
              ...
              <li>
                <strong className="text-ink">Actividad:</strong> Servicios de
          ...
          <div>
            ...
            <p>
              El presente aviso legal regula el uso del sitio web y de los
              servicios profesionales de psicología ofrecidos por Almudena
              Marchesi Fernández (en adelante, &ldquo;la Profesional&rdquo;). El
              acceso y la utilización de este sitio web atribuye la condición de
              usuario e implica la aceptación plena de todas las condiciones
          ...
          <div>
            ...
            <p>
              ...
              como su diseño gráfico y códigos fuente, son propiedad intelectual
              de la Profesional o de terceros que han autorizado su uso, sin que
              puedan entenderse cedidos al usuario ninguno de los derechos de
          ...
          <div>
            ...
            <p>
              La Profesional no se hace responsable de los posibles daños o
              ...
              electrónico. Asimismo, la Profesional no se hace responsable de
              retrasos o bloqueos en el uso causados por deficiencias o
              sobrecargas en los servidores de Internet o en otros sistemas
              electrónicos.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Las relaciones entre la Profesional y el usuario se regirán por la
              normativa española vigente, siendo competentes para la resolución
              de cualquier controversia los Juzgados y Tribunales de la ciudad
              de Madrid, salvo que la ley aplicable disponga otra cosa.
            </p>
          </div>
