        ...
        <section className="space-y-10 text-ink-soft leading-relaxed">
          ...
          <div>
            ...
            <p>
              ...
              recuerde información sobre su visita, como su idioma de
              preferencia o su estado de autenticación, facilitando la
              navegación y haciéndola más eficiente.
            </p>
          </div>
                ...
                <tbody className="divide-y divide-line">
                  <tr>
                    ...
                    <td className="px-4 py-3">
                      Autenticación del usuario. Token JWT cifrado con
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3">
                      Cookie interna del framework Next.js para la gestión de
                      la navegación y la hidratación del lado del cliente.
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div>
            ...
            <p>
              ...
              <strong className="text-ink">
                no utiliza cookies de terceros
              </strong>
              . No se emplean servicios de analítica (Google Analytics, etc.),
              redes publicitarias, ni píxeles de seguimiento. Su navegación en
              este sitio no es rastreada ni compartida con terceros.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              para que le avise cuando se envía una cookie. Sin embargo, si
              rechaza las cookies técnicas, no podrá acceder al portal de
              pacientes, ya que la cookie de autenticación es necesaria para
