-- ============================================================================
-- 0083_bono_manual_max_100.sql
-- ----------------------------------------------------------------------------
-- Sube el límite de sesiones de bono manual de 50 a 100.
-- ============================================================================
...
begin
  ...
  -- Límite actualizado: 1-100 sesiones
...
comment on function public.bono_asignar_manual(uuid, uuid, int, text, int, int, text, boolean) is
  'Asignación manual de bono + pago. Máximo 100 sesiones. p_metodo: tarjeta | bizum | transferencia | regalo | efectivo | klarna.';
