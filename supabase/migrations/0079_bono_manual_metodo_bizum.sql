-- 0079 — bono_asignar_manual: añade método `bizum` (registro manual de cobro por Bizum).
-- Misma lógica contable que tarjeta/transferencia/efectivo/klarna. Orden UI sugerido: tras tarjeta.
...
comment on function public.bono_asignar_manual(uuid, uuid, int, text, int, int, text, boolean) is
  'Asignación manual de bono + pago. p_metodo: tarjeta | bizum | transferencia | regalo | efectivo | klarna.';
