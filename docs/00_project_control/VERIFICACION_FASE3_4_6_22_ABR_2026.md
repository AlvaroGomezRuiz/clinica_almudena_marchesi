...
> **SEPA bancario en Stripe**: no activado en panel del usuario; la app ya soporta `automatic_payment_methods`; ver `docs/05_operations/ACTIVAR_SEPA_STRIPE.md` o equivalente en `docs/05_operations/`.
...
- Smoke manual: usar `docs/05_operations/TESTING_CHECKLIST.md` en el entorno deseado (preview/producción).
