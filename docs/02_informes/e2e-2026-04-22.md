...
6. **`testing-checklist.md` manual pass** (`docs/05_operaciones/`) por Almudena antes del primer cliente
...
- `docs/03_ingenieria/arquitectura-visual.md` → diagrama completo
  (frontend Vercel ↔ Supabase ↔ Stripe ↔ Resend ↔ Sentry) con mermaid.
- `docs/01_auditorias/backend.md` → review backend por capas.
- `docs/01_auditorias/seguridad-rgpd.md` (+ §14 Adenda hardening).
- `docs/00_proyecto/estado-y-pendientes.md` (§10 Hito Final).
