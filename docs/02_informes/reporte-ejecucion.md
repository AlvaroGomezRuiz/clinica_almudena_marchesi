...
- Seis auditorías técnicas en `docs/01_auditorias/`.
- Informe ejecutivo cliente: `docs/02_informes/ejecutivo-cliente.md`.
- Sistema de diseño: `docs/04_diseno/sistema-diseno.md`.
- Roadmap y arquitectura: `docs/03_ingenieria/`.
...
- Arquitectura profunda: `docs/01_auditorias/arquitectura.md`.
- Auditoria backend: `docs/01_auditorias/backend.md`.
- Auditoria frontend: `docs/01_auditorias/frontend.md`.
- Auditoria DB: `docs/01_auditorias/base-de-datos.md`.
- Seguridad + RGPD: `docs/01_auditorias/seguridad-rgpd.md`.
- Estado pendiente: `docs/00_proyecto/estado-y-pendientes.md`.
