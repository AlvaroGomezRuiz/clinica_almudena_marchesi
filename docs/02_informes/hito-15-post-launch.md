...
| 6 | Click-through manual con `docs/05_operaciones/testing-checklist.md` | Guía actualizada con §4 automáticos y §4B post-hardening | No |
...
`docs/05_operaciones/testing-checklist.md §4`.
...
### 2.6 Click-through manual (`docs/05_operaciones/testing-checklist.md`)
...
4. **Pasar el `docs/05_operaciones/testing-checklist.md`** una última vez antes de avisar al
...
2. Pasado el click-through del `docs/05_operaciones/testing-checklist.md`.
