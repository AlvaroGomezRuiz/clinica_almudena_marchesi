...
> Documento vivo. Complementa a `ARQUITECTURA_TECNICA.md` con diagramas Mermaid renderizables en GitHub / VS Code.
...
- `docs/03_engineering/ARQUITECTURA_TECNICA.md` — visión detallada con invariantes técnicos.
- `docs/03_engineering/ROADMAP.md` — qué queda pendiente post-hito 14.
- `docs/00_project_control/PENDIENTES_Y_CHECKLIST.md` — estado vivo del proyecto (es la fuente de verdad operativa).
