...
| — | Transferencia bancaria SEPA en Stripe | Código ya usa `automatic_payment_methods: true` → depende de activar SEPA en Stripe Dashboard. No requiere código | Documentar en `docs/05_operaciones/activar-sepa-stripe.md` |
...
- `docs/05_operaciones/activar-sepa-stripe.md` — checklist para activar SEPA en Dashboard Stripe.
...
- Smoke test manual con `docs/05_operaciones/testing-checklist.md`.
- Commit + push.
...
**Fecha**: 22 abril 2026  
**Estado**: FASE 0–2 cerradas; **FASE 3–4 (UX + audio) y FASE 5 (tsc + build)** verificados en repo — `docs/00_proyecto/verificacion-fases-3-4-6.md`. SEPA dashboard pendiente (operativo, no de código). Smoke E2E manual según `docs/05_operaciones/testing-checklist.md` al desplegar.
