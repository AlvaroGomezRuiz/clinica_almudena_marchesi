...
```
   ...
   (opcional, no desplegado): backend/ FastAPI — conservado para eventual
   migracion a infraestructura propia sin vendor lock-in.
```
...
|-----------------------------------------|--------------|---------|------------------------------------------------------------------|------------------------|
| Credenciales demo (`Almudena2026!`)     | alta         | alta    | Documentado en `PENDIENTES_Y_CHECKLIST.md` como pre-produccion  | rotar antes de go-live |
...
|---------------------------------------------------------|-----------|-----------------------------------------------------|
| Carpeta `backend/` sin despliegue definido              | baja      | `backend/` (FastAPI parado)                        |
...
**Recomendacion**: proceder a go-live tras ejecutar el checklist de rotacion documentado en `docs/00_project_control/PENDIENTES_Y_CHECKLIST.md` seccion 6.
