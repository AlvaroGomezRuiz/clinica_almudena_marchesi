...
Query de verificacion disponible en `docs/05_operations/RUNBOOK.md`.
...
1. Rotar todas las passwords y API keys (checklist seccion 6 de `PENDIENTES_Y_CHECKLIST.md`).
